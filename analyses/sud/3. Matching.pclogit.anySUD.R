...
mean(is.na(df1$neighborhood_safety_2))
...
#alternative
#"anysupnonfam_1"        "neighborhood_safety_2" "school_safety_t_2"     "neighborhood_exp_3" 
cfit2 <- clogit(y ~
                  + anysupnonfam_1 + neighborhood_safety_2 + school_safety_t_2 + neighborhood_exp_3
                + strata(id)
                , data = df1)
...
mean(is.na(df1$anysupnonfam_1))
mean(is.na(df1$neighborhood_safety_2))
mean(is.na(df1$school_safety_t_2))
mean(is.na(df1$neighborhood_exp_3))

...
cfit2 <- clogit(y ~
                  anysupparent_s_1+fam_sat_1+home_safety_s_1+neighborhood_exp_1+neighborhood_safety_s_2
                +neighborhood_exp_s_2+school_safety_y_s_2+school_safety_t_s_2+srvc_use_s_2+anysupadu_s_3
                +prrelation_s_3+resid_stab_3+neighborhood_safety_s_3
                + strata(id)
                , data = df1)
